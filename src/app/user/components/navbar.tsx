    ...
    <header className="flex items-center justify-between px-10 py-5 bg-gray-100 shadow-md">
      ...
      <div className="flex items-center space-x-6">
        <nav className="flex space-x-6 font-bold">
          <Link href="/user/" className="px-4 py-2 rounded-md transition hover:bg-limeCustom">Home</Link>
          <Link href="/user/lapangan" className="px-4 py-2 rounded-md transition hover:bg-limeCustom">Lapangan</Link>
          <Link href="/user/pembayaran" className="px-4 py-2 rounded-md transition hover:bg-limeCustom">Pembayaran</Link>
        </nav>
        <button
